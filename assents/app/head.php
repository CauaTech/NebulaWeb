...
<link href="<?php echo $flow;?>assents/app/datatables.min.css" rel="stylesheet">
<script src="<?php echo $flow;?>assents/app/datatables.min.js"></script>

<?php 

$sql_dashboard = "SELECT * FROM `nebula-infectado`";
$in = $connect->query($sql_dashboard)->num_rows;

$consult_infect = $connect->query($sql_dashboard);

$sql_pass = "SELECT * FROM `nebula-password`";
$pw = $connect->query($sql_pass)->num_rows;
